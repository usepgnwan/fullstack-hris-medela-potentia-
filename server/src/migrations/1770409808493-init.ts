...
export class Init1770409808493 implements MigrationInterface {
    name = 'Init1770409808493'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "absensi" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "karyawan_id" uuid NOT NULL, "address" text NOT NULL, "catatan" text, "date" date NOT NULL, "file" text, "lat" character varying NOT NULL, "lng" character varying NOT NULL, "time" TIME NOT NULL, "type" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_518518f9aeb10970130bbe30e8f" PRIMARY KEY ("id"))`);
